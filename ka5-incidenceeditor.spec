...
# Source0-md5:	fecc36224ccdf1b673b7fa37741e7b7d
...
%ghost %{_libdir}/libKPim5IncidenceEditor.so.5
%attr(755,root,root) %{_libdir}/libKPim5IncidenceEditor.so.*.*.*
...
%{_libdir}/cmake/KPim5IncidenceEditor
